                    ...
                    >
                      {item.name === 'Cek Reservasi' ? (
                        <button
                          ...
                          className={`block w-full text-left px-4 py-3 rounded-lg text-lg font-medium transition-colors ${location.pathname === item.path
      ...
      <section className="bg-emerald-900">
        <div className="max-w-7xl mx-auto px-3 sm:px-4 lg:px-8 py-8 sm:py-12">
          ...
          <div className="rounded-xl overflow-hidden shadow-xl">
            <iframe
              src={`https://www.google.com/maps?q=${footerContent?.map?.lat || -7.8332533},${footerContent?.map?.lng || 112.5288334}&hl=id&z=15&output=embed`}
              width="100%"
              height="300"
              style={{ border: 0 }}
              allowFullScreen=""
            ...
            <div>
              ...
              <div className="space-y-3 text-emerald-200 text-sm sm:text-base">
                ...
                <div className="flex items-center gap-3">
                  ...
                  <a href={`tel:${footerContent?.phone || '+6281130700206'}`} onClick={() => trackPhoneClick('Footer')} className="hover:text-emerald-300">
                    {footerContent?.phone || '(0341) 597828'}
                  </a>
                </div>
                <div className="flex items-center gap-3">
                  <Mail className="w-5 h-5 flex-shrink-0" />
                  <a href={`mailto:${footerContent?.email || 'reservasi@spencergreenhotel.com'}`} onClick={() => trackEvent('Contact', 'click_email', 'Footer')} className="hover:text-emerald-300">
                    {footerContent?.email || 'reservasi@spencergreenhotel.com'}
                  </a>
                </div>
              </div>
            </div>
            ...
            <div>
              ...
              <div className="flex flex-wrap gap-3">
                <a
                  ...
                  onClick={() => trackEvent('Social', 'click_tiktok', 'Footer')}
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  onClick={() => trackEvent('Social', 'click_instagram', 'Footer')}
                  className="w-10 h-10 sm:w-11 sm:h-11 bg-emerald-800 rounded-full flex items-center justify-center hover:bg-emerald-700 transition-colors"
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  onClick={() => trackEvent('Social', 'click_facebook', 'Footer')}
                  className="w-10 h-10 sm:w-11 sm:h-11 bg-emerald-800 rounded-full flex items-center justify-center hover:bg-emerald-700 transition-colors"
