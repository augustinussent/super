              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <select
                    ...
                    className="w-full h-12 pl-10 pr-4 border rounded-lg appearance-none bg-white focus:ring-2 focus:ring-emerald-500 text-sm"
                  >
                    {[1, 2, 3, 4].map(n => (
              ...
              <div>
                ...
                <div className="relative flex">
                  ...
                  <input
                    ...
                    className="w-full h-12 pl-10 pr-20 border rounded-lg focus:ring-2 focus:ring-emerald-500 text-sm uppercase"
                  />
                  <button
          ...
          <section ref={roomsRef} className="py-16 sm:py-20 bg-emerald-50/50" data-testid="available-rooms-section">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
              <div className="text-center mb-10 sm:mb-12">
                ...
                <button
                  onClick={() => setShowSearchModal(true)}
                  className="text-emerald-600 hover:text-emerald-700 font-medium text-sm mt-2 flex items-center justify-center mx-auto gap-1"
                >
              ...
              <div className="relative rounded-2xl overflow-hidden">
                ...
                <div className="absolute inset-0 bg-gradient-to-r from-emerald-900/90 to-transparent flex items-center">
                  <div className="p-6 sm:p-8 md:p-12 max-w-lg">
                    ...
                    <Button onClick={() => setShowSearchModal(true)} className="bg-white text-emerald-800 hover:bg-emerald-100">
                      Book Now
                    </Button>
                  </div>
                </div>
